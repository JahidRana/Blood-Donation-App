...
//                            mMap.moveCamera(CameraUpdateFactory.newLatLng(s));
                            ...
                            try {
                                ...
                                Intent intent = new Intent(Become_Donor_Activity.this, PickLocation.class);
                                intent.putExtra("lat", addresses.get(0).getLatitude());
                                intent.putExtra("lon", addresses.get(0).getLongitude());
